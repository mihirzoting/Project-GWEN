    ...
    <form onSubmit={handleSubmit} className="relative">
      <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/40 px-4 py-3 shadow-[0_0_32px_rgba(59,130,246,0.12)] backdrop-blur-xl">
        ...
        <button
          ...
          className={`rounded-xl border px-3 py-2 text-[10px] uppercase tracking-[0.18em] transition ${
            includeScreen
        ...
        <button
          ...
          className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-[10px] uppercase tracking-[0.18em] text-slate-400 transition hover:border-white/20"
        >
          Capture
        </button>
        <motion.button
